...
const fieldStyles = tv({
  slots: {
    ...
    label: "select-none text-base/6 text-fg dark:text-neutral-200 group-disabled:opacity-50 sm:text-sm/6",
    fieldError:
  ...
  return (
    <Group
      ...
      className={composeTailwindRenderProps(className, [
        ...
        "group relative inset-ring inset-ring-neutral-300 dark:inset-ring-neutral-800 flex items-center overflow-hidden rounded-lg shadow-xs transition duration-200 ease-out",
